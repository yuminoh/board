...
<button type="button" class="btn btn-outline-secondary" ><a href="./post/add.do" class='nav-link link-dark px-2'>add</a></button>
  ...
  <tbody>
  	<c:forEach var="postVO" items="${list}">
  		...
  		<tr>
  			...
  			<td scope="row"><a href="./post/read.do?postno=${postVO.postno}">${postVO.title}</a> </td>
