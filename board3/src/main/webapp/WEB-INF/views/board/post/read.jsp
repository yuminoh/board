...
function showReplyList(){
	...
	var url = "${pageContext.request.contextPath}/board/post/replylist.do";
...
$(document).on('click', '#btn_add', function(){
	...
	$.ajax({
		url: "${pageContext.request.contextPath}/board/post/reinsert.do"
		, data : paramData
		, type : 'POST'
		, dataType : 'text'
...
function fn_reupdateReply(replyno, rcontent){
	...
	$.ajax({
		url: "${pageContext.request.contextPath}/board/post/reupdate.do"
		, data : paramData
		, type : 'POST'
		, dataType : 'text'
		, success: function(result){
...
function fn_deleteReply(replyno){
	...
	$.ajax({
		url: "${pageContext.request.contextPath}/board/post/redelete.do"
		, data : paramData
		, type : 'POST'
		, dataType : 'text'
		, success: function(result){
