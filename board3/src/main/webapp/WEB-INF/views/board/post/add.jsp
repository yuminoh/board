...
<body>
 <form class="needs-validation" name='frm' method='post' action='/board/post/add.do' novalidate>
    <div class="container">
    <div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1" name='writer'>작성자: ${id} </span>
</div>
